    ...
    <div className="min-h-screen flex items-center justify-center bg-surface bg-grid bg-[size:32px_32px] relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl bg-slate-950/80 shadow-lg shadow-sky-500/20 ring-1 ring-sky-400/30">
